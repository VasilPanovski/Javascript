class TrainingCourse {
    ...
    addTopic(title, topicDate) {
        if (typeof title === 'string' && typeof topicDate.getMonth === 'function') {
            let topic = {title: title, date: topicDate};
            this.topics.push(topic);
            this.topics.sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());
